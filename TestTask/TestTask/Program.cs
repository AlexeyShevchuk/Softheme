...
namespace Softheme
{
    class Program
    {
        ...
        static int Calc(int[] coins,  int p, int i = -1)
        {
            i++;
            ...
            res = Calc(coins, p, i); // Recursively go to the end of the array.
            ...
            if (buff == 0) // If the buff is 0, the sum of the coins is 200.
                return 1;
            if (buff > 0)
                return res + Calc(coins, buff, --i);  //Next step is to calculate combinations for 100.
            return 0;
        }
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine(Calc(coins, 200));
            Console.ReadLine();
        }
    }
}